...
class MCPConfiguration {
     ...
     */
    async isConfiguredInFile(filePath) {
    ...
    async configure() {
        try {
            ...
            // Get API credentials
            const apiKey = await this.context.globalState.get('API_KEY') || 'your-api-key-here';
...
//# sourceMappingURL=mcp-configuration.js.map